...
- [Lineamientos de Templates](../../src/shared/templates/TEMPLATE_GUIDELINES.md) — Sistema de diseño visual para crear nuevos templates PdfKit: paleta de colores, tipografía, estructura, reglas de paginación y convenciones de ID
